...
q6 = Question('С чем связан подъем уровня воды ', 'Москва', 'Джакарта', 'Бангладеш', 'Пекин')
q7 = Question('Какой процесс протекает в листе растения?', 'Фотосинтез', 'Терморегуляция', 'Энергообмен', 'Газообмен')
q8 = Question('Как определить уклон реки?', 'отношение ее падения к длине  ', 'сумма длины и падения ', 'разность длины и падения', 'не знаю')
q9 = Question('Как обозначается сила тока в физике?', 'I', 'F', 'V', 'P')
q10 = Question('Что такое рефлекс?', ' быстрая непроизвольная реакция организма на определенный РАЗДРАЖИТЕЛЬ', 'раздражение тела ', 'ответная реакция организма', 'не знаю')
